  ...
  <v-container fluid class="wrapper">
    ...
    <v-row>
      <v-col class="col-left">
        <FormDisplayCommittee
            class="form-display"
            v-if="FDisDisplayed"
            @open-edit-menu="openEditMenu"
        />
        <ComparisonMenuCommettee
            class="comparison"
            v-if="CMisDisplayed"
...
<script>
import EditMenuCommittee from "@/components/CommitteeViewComponants/EditMenuCommittee.vue";
import FormDisplayCommittee from "@/components/CommitteeViewComponants/FormDisplayCommittee.vue";
import LogoutButton from "@/components/LogoutButton.vue";
import ComparisonMenuCommettee from "@/components/CommitteeViewComponants/ComparisonMenuCommittee.vue";
import ViewApplication from "@/components/ViewApplication.vue";
import axios from "@/plugins/axios";
export default {
  components: {ComparisonMenuCommettee, EditMenuCommittee, FormDisplayCommittee, LogoutButton, ViewApplication},
  data() {
    return {
      VAisDisplayed: false,
      EMisDisplayed: false,
