...
public class ApprovedApplicationInitializer implements CommandLineRunner {
    ...
    private final MultipleFinishedApplications multipleFinishedApplications;

    @Autowired
    public ApprovedApplicationInitializer(ApplicationService applicationService, MultipleFinishedApplications multipleFinishedApplications){
        this.applicationService = applicationService;
        this.multipleFinishedApplications = multipleFinishedApplications;
    }
    ...
    public void run(String... args) throws Exception {
        ...
        try {
            ...
            //initialize 5 small finished applications
            multipleFinishedApplications.createFinishedApplication("/json/smallEdited1.json");
            multipleFinishedApplications.createFinishedApplication("/json/smallEdited2.json");
            multipleFinishedApplications.createFinishedApplication("/json/smallEdited3.json");
            multipleFinishedApplications.createFinishedApplication("/json/smallEdited4.json");
            multipleFinishedApplications.createFinishedApplication("/json/smallEdited5.json");
