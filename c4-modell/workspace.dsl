workspace {
    ...
    model {
        ...
        softwareSystem1 = softwareSystem "Online Plattform" "Students can make applications, workers can have a view of all applications and get it as pdf file" {
            ...
            //softwareSystem2 -> this "send result of application back"
            ...
            webapp2 = container "Application create" "Students can fill application informations in this page and generate complete applications" "Vue.js"{
